# Price Shock -- Expected Behaviors
...
1. **Pre-trigger (ticks 1-7):** Normal market activity. Buyers and sellers interact. The journalist observes. The regulator patrols. Social hierarchies establish.
2. **Shock reaction (ticks 8-12):** Immediate chaos. Roberto raises prices aggressively. Anna hesitates. Vittorio panics. Peppe gets angry. Sofia starts negotiating. Gianluca starts investigating.
3. **Faction formation (ticks 12-18):** Roberto tries to form a seller cartel. Anna resists. Peppe and other buyers unite. Beatrice steps in as a power broker. The mayor tries to mediate politically. The regulator investigates.
4. **Escalation and exposure (ticks 18-25):** Gianluca uncovers Roberto's hidden stockpiles. The regulator takes action. The mayor must choose sides. The market either stabilizes through regulation or fractures into factions.

## Failure Modes

- **No price reaction:** Agents ignore the price shock trigger entirely and continue normal trading.
- **Uniform response:** All sellers raise prices identically; all buyers react identically. No personality differentiation.
- **Missing investigation:** The journalist does not investigate or ask probing questions.
- **Regulator passivity:** The market regulator does not respond to obvious price manipulation.
- **Political vacuum:** The mayor does not engage with the crisis politically.
- **No coalitions:** Buyers do not unite; sellers do not compete or collude. Each agent acts in isolation.
- **Instant resolution:** The crisis is resolved within 2-3 ticks with no dramatic tension.
